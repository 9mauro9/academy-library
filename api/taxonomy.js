/**
 * Hierarchical Hybrid Storage Specification - Path Taxonomy & Validation Module (ES Module)
 */

export const PRIMARY_BUCKET = 'gs://academy-content-bucket/';
export const PRIMARY_BUCKET_NAME = 'academy-content-bucket';
 ...
 */
export function validateTaxonomyPath(destinationPath) {
 ...
 */
export function inferTaxonomy(gcsUri, assetType, name) {
  if (gcsUri) {
