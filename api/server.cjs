...
app.get('/api/tracks', async (req, res) => {
  try {
    await cache.ensureLoaded();
    console.log('[GET /api/tracks] cache.curriculumMap length:', cache.curriculumMap ? cache.curriculumMap.length : 'null');
    if (cache.curriculumMap && cache.curriculumMap.length > 0) {
